...
*/
 ...
 /*   public class BuzzButtonChangedEventArgs : EventArgs
   ...
   /// <summary>
    ...
    public class BuzzReadBufferEventArgs : EventArgs
    {
        /// <summary>Current states of the buttons</summary>
        public Byte[] Buffer;
        /// <summary>
        ...
        /// </summary>
        /// <param name="arrStates">State of the buttons</param>
        public BuzzReadBufferEventArgs(Byte[] rrbuffer)
        {
            Buffer = rrbuffer;
        }
    }

   public delegate void BuzzReadBufferEventHandler(object sender, Byte[] buffer);
    // public delegate void BuzzReadBufferEventHandler(object sender, Byte[] inbuffer,Byte[] outbuffer);
    ...
    public class BuzzHandsetDevice : HIDDevice
    {
		...
		/// </summary>
		public event BuzzReadBufferEventHandler OnReadBuffer;
		/// <summary>
        ...
        public void WriteReport(Byte[] WrBuffer)
        {
            
            BuzzOutputReport oRep = new BuzzOutputReport(this);	// create output report
            oRep.SetWriteBuffer(WrBuffer);
            try
            {
                Write(oRep); // write the output report
            }
        ...
        public static BuzzHandsetDevice FindBuzzHandset(int nVid, int nPid)
        {
			// VID and PID for Buzz device are 0x054c and 0x1000 respectively
            return (BuzzHandsetDevice)FindDevice(nVid, nPid, typeof(BuzzHandsetDevice));
        }
		#endregion
		...
		protected override void HandleDataReceived(InputReport oInRep)
		{
			// Fire the event handler if assigned
				...
				OnReadBuffer(this,oBuzIn.Buffer);
