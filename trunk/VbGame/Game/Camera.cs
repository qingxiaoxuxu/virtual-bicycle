...
namespace VirtualBicycle
{
    ...
    public class Camera : ICamera
    {
        ...
        public virtual void UpdateProjection()
        {
            ...
            frustum.proj = Matrix.CreatePerspective(NearPlaneWidth, NearPlaneHeight, near, far);
    ...
    public class FpsCamera : Camera
    {
        ...
        public void TurnLeft()
        {
            ...
            orientation *= Quaternion.CreateFromAxisAngle(top, -turnSpeed);
        ...
        public void TurnUp()
        {
            orientation *= Quaternion.CreateFromAxisAngle(new Vector3(1, 0, 0), -turnSpeed);
            orientation.Normalize();
        }
        ...
        {
            orientation *= Quaternion.CreateFromAxisAngle(new Vector3(0, 0, 1), turnSpeed);
            orientation.Normalize();
        }
